    ...
    <div>
      ...
      <div className='container'>
        <div className="text-container">
          ...
          <button className="button" onClick={() => loggedIn ? navigate('/Classes') : navigate('/Signin')}>Find out more</button>
        </div>
      </div>
      ...
      <h2 style={{"paddingLeft":"55px",color:"#3F6E71"}}>Yoga anytime</h2>
            ...
            <button className='browse-button' onClick={() => loggedIn ? navigate('/Classes') : navigate('/Signin')}>Browse Classes</button>
            </div>
        </div>
        <Footer/>
      </div>
